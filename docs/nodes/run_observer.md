...
## Deploy an Observer Node Step-by-Step
...
If you want to modify the configuration of the node, you can edit the `config.ini` file of the node directory, check more details in the [Configure Node](./configure_node.md) section.
