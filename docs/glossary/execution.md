...
EVMC (Ethereum Client-VM Connector API) is the executor interface abstracted by Ethereum, aimed at interfacing with various types of executors. FISCO BCOS currently adopts mainstream smart contract language of Web3.0, Solidity, and therefore continues to use EVMC abstraction of the executor interface."
