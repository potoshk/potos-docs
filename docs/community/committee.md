...
On-chain roles can be divided into three categories based on different responsibilities: `governance`, `contract administrator`, and `use`, with the three roles managing and being managed in turn.
